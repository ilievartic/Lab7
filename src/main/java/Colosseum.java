...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        while(tempPokemon.hitPoints > 50 || tempPokemon.hitPoints < 0) {
            System.out.println("Sorry. Hit points must be between 1 and 50: ");
            tempPokemon.hitPoints = myScan.nextInt();
        }
        System.out.println("How many attack points will it have? ");
        tempPokemon.attackLevel = myScan.nextInt();
        while(tempPokemon.attackLevel > 50 || tempPokemon.attackLevel < 0) {
        ...
        while(tempPokemon.defenseLevel > 50 - tempPokemon.attackLevel || tempPokemon.defenseLevel < 0) {
